...
import com.scujcc.dada.add.KeyModel;
import com.scujcc.dada.add.NumberKeyBoard;
...
public class KeyboardUtil {
    ...
    private NumberKeyBoard mKeyboardView;
    ...
    private KeyboardUtil(Activity activity, boolean ifRandom) {
     ...
     *
     */
    private static void hideSystemSoftKeyboard(Context context, EditText editText) {
    ...
    private OnOkClick mOnOkClick = null;
