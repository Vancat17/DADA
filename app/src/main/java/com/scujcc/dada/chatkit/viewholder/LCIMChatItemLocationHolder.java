...
import com.scujcc.dada.chatkit.event.LCIMLocationItemClickEvent;
...
public class LCIMChatItemLocationHolder extends LCIMChatItemHolder {
  ...
  public void initView() {
    ...
    contentView = itemView.findViewById(R.id.locationView);
    conventLayout.setBackgroundResource(isLeft ? R.drawable.send_to_me : R.drawable.send_to_other);
