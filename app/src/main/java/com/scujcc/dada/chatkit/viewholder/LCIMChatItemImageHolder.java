...
import com.scujcc.dada.chatkit.activity.LCIMImageActivity;
...
public class LCIMChatItemImageHolder extends LCIMChatItemHolder {
  ...
  public void initView() {
    ...
    if (isLeft) {
      contentView.setBackgroundResource(R.drawable.send_to_me);
    } else {
      contentView.setBackgroundResource(R.drawable.send_to_other);
    }
